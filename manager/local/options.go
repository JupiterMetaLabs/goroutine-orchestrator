...
// Option satisfies the interfaces.GoroutineOption interface.
type Option func(*goroutineOptions)

// Ensure Option satisfies interfaces.GoroutineOption
var _ interfaces.GoroutineOption = Option(nil)
